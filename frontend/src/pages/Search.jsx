...
import { OpenCard } from "../redux/products/Productdetails";

const sortOptions = [
  { name: "Most Popular", href: "most_popular", current: true },
  { name: "Best Rating", href: "best_rating", current: false },
  { name: "Newest", href: "newest", current: false },
  { name: "Price: Low to High", href: "price_low_to_high", current: false },
  { name: "Price: High to Low", href: "price_high_to_low", current: false },
];
// const subCategories = [
//   // { name: "Totes", href: "#" },
//   // { name: "Backpacks", href: "#" },
...
export default function Search() {
  ...
  const updateSearchParams = (option, checked, section) => {
    setSearchParams((prevParams) => {
      ...
      const currentFilter = params.getAll(section);

      if (checked) {
        if (!currentFilter.includes(option.value)) {
          params.append(section, option.value);
        }
      } else {
        params.delete(section);
        currentFilter.forEach((value) => {
